...
Config.EnableGovenor     = false -- set to true if you have a govenor system setup
Config.TaxBillingCronJob = '0 * * * *' -- cronjob time runs every 1hr on the hour
...
Config.Houses = {
	...
	{    -- house47
        ...
        menucoords      = vector3(2235.07, -141.05, 47.62),
        blipcoords      = vector3(2234.82, -146.91, 47.64),
        showblip        = true
    },
	{    -- house47
        name            = 'House 48',
        ...
        menucoords      = vector3(-1637.30, -1357.70, 84.42),
        blipcoords      = vector3(-1639.18, -1356.54, 84.43),
        showblip        = true
    }
...
Config.HouseDoors = {
    ...
    ---------------------------------------------------------------------------
	{
        ...
        name            = 'House 47',
        doorid          = 1762076266,
        doorcoords = vector3(2238.11, -141.63, 47.60)
    },
    {
        houseid         = 'house47',
        name            = 'House 47',
        doorid          = 2689340659,
        doorcoords = vector3(2234.82, -146.91, 47.64)
    },
    ---------------------------------------------------------------------------
	{
        houseid         = 'house48',
        name            = 'House 48',
        doorid          = 1606546482,
        doorcoords = vector3(-1645.98, -1367.70, 84.52)
    },
	{
        houseid         = 'house48',
        name            = 'House 48',
        doorid          = 818583340,
        doorcoords = vector3(-1649.01, -1358.55, 84.46)
    },
	{
        houseid         = 'house48',
        name            = 'House 48',
        doorid          = 2310818050,
        doorcoords = vector3(-1636.94, -1352.22, 83.97)
    },
    ---------------------------------------------------------------------------
}
